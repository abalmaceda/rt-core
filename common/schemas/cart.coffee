...
# Carts
###
RealTimeCore.Schemas.CartItem = new SimpleSchema
  _id:
    type: String
  productId:
    type: String
...
RealTimeCore.Schemas.Cart = new SimpleSchema
  shopId:
    type: String
    index: 1
  ...
  userId:
    ...
    index: 1
  items:
    type: [RealTimeCore.Schemas.CartItem]
    optional: true
  requiresShipping:
    ...
    optional: true
  shipping:
    type: RealTimeCore.Schemas.Shipment
    optional: true
    blackbox: true
  payment:
    type: RealTimeCore.Schemas.Payment
    optional: true
    blackbox: true
  totalPrice:
    label: "Total Price"
